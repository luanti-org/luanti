...
```lua
{
    ...
    -- This new code removes the glitch that caused entities and players to jolt up on the edge of a node. These make movement through the environment feel higher quality.
