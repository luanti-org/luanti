...
this state, the mapblock must first be "emerged". This means that it is either
loaded from disk, or, if it doesn't yet exist, generated by the map generator.
Mapblocks are loaded in a broad area around each player. They are "unloaded"
