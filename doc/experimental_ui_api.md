...
> useful for explaining some of the features of the UI API. When this occurs, a
> block like this precedes the example to note the discrepancy between the
...
> **Note**: Since the UI API has no core theme bundled by default at this point
> (aside from the prelude theme), a few extra style properties are required to
> make anything visible.
...
become focused, whereas pressing Shift + Tab will transfer focus to the
