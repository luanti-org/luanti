...
It can be copied over from an old world to a newly created world.
    ...
    World
    ©À©¤©¤ auth.txt ©¤©¤©¤©¤©¤ Authentication data
    ©À©¤©¤ auth.sqlite ©¤©¤ Authentication data (SQLite alternative)
    ©À©¤©¤ env_meta.txt ©¤ Environment metadata
    ©À©¤©¤ ipban.txt ©¤©¤©¤©¤ Banned IPs/users
    ©À©¤©¤ map_meta.txt ©¤ Map metadata
    ©À©¤©¤ map.sqlite ©¤©¤©¤ Map data
    ©À©¤©¤ players ©¤©¤©¤©¤©¤©¤ Player directory
    ©¦   ©¦©¤©¤ player1 ©¤©¤ Player file
    ©¦   ©¸©¤©¤ Foo ©¤©¤©¤©¤©¤©¤ Player file
