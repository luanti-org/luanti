...
struct SEvent
{
	...
	struct SMouseInput
	{
		...
		union {
			...
			/** The mouse button that was pressed down or left up.
			 * Only valid for events where a mouse button is pressed down or left up.
			 * Note that there are dedicated events for the LMB/MMB/RMB being pressed down or left up.
			 */
			u32 Button;
		};
