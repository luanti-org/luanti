...
const table_key &KeyPress::lookupScancode() const
{
	...
	case InputType::KEYBOARD:
		return lookup_scancode(getValue<InputType::KEYBOARD>());
	case InputType::LEGACY_KEYCODE:
		return lookup_keykey(getValue<InputType::LEGACY_KEYCODE>());
	default:
		return invalid_key;
	}
}
...
KeyPress::operator bool() const
{
	...
	case InputType::LEGACY_KEYCODE:
		return Keycode::isValid(getValue<InputType::LEGACY_KEYCODE>());
